<?php
	if ( isset($_GET['schema']) ) {
		$active_schema = $_GET['schema'];
	}
	else {
		header('location:manage.databases.php');
	}
	...
	$dbuser = 'delegate';
	$dbpass = '.@database';
	$dbname = $active_schema;

	// PREPARE THE QUERY
	$mysqli = new mysqli($dbhost, $dbuser, $dbpass, $dbname) or die("Unable to Connect to '$dbhost'");
		...
		<div class="db-list">
			<table class="table">
				<thead class="table-head">
					<tr>
						<th>Available Tables in <?php echo $active_schema; ?></th>
					</tr>
				</thead>
